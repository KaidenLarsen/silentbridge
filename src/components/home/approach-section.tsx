...
const steps = [
  ...
  },
  {
    ...
    description: "Personalize the system for each user&aposs unique communication style with real-time adjustments and learning."
  }
]
      ...
      <div className="container">
        <div className="max-w-[800px] mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            We&aposre building a future where personalized AI systems empower non-verbal autistic individuals 
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-12">
          <div>
            ...
            <p className="text-muted-foreground">
                ...
                We&aposre openly sharing these ideas to gather feedback, build a community of 
                like-minded individuals, and work together towards making this vision a reality.
            </p>
            <p className="text-muted-foreground mt-4">
                While we&aposre still in the learning and planning stages, we believe in 
